...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        String serverInfo = "120.26.254.90:3306";
        ...
        FastAutoGenerator.create("jdbc:mysql://"+serverInfo+"/"+dbName+"?useUnicode=true&characterEncoding=utf-8&useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Shanghai&tinyInt1isBit=true", userName, password)
                .globalConfig(builder -> {
                    builder.author("Timothy")        // 设置作者
